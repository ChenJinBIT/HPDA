...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--ncf', type=int, default=64, help='# of classifier in the first conv layer')
        parser.add_argument('--netD', type=str, default='feature', help='specify discriminator architecture [feature|basic | n_layers | pixel]. The feature model is the input is feature vector.The basic model is a 70x70 PatchGAN. n_layers allows you to specify the layers in the discriminator')
        parser.add_argument('--netG', type=str, default='feature', help='specify generator architecture [feature|resnet_9blocks | resnet_6blocks | unet_256 | unet_128]')
        parser.add_argument('--netC', type=str, default='feature', help='specify classifier architecture [feature|feature_handama]')
        ...
        # dataset parameters
        parser.add_argument('--dataset_mode', type=str, default='feature', help='chooses how datasets are loaded. [unaligned | aligned | single | colorization|feature]')
        parser.add_argument('--direction', type=str, default='AtoB', help='AtoB or BtoA')
        parser.add_argument('--class_consist', action='store_true', help='if true, takes features with respect to label, otherwise takes them in order')
