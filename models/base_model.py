...
class BaseModel(ABC):
    ...
    def get_image_paths(self):
        ...
        return self.image_paths,self.image_paths_t
    def get_image_labels(self):
        """ Return image labels that are used to load current data"""
        if not self.isTrain:
            return self.image_labels,self.image_labels_t
        else:           
    ...
    def set_requires_grad_G(self, nets, requires_grad=False):
        """Set requies_grad=Fasle for all the networks to avoid unnecessary computations
        Parameters:
            nets (network list)   -- a list of networks
            requires_grad (bool)  -- whether the networks require gradients or not
